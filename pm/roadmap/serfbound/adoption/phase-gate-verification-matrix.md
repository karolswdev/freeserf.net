...
| 1 | Reference oracle is trustworthy | Data-free and local-asset oracle outputs captured, documented, and isolated from product code | In progress; CI-safe RNG fixture and local/manual SPAU metadata captured |
...
SB-1-01 target selection, SB-1-02's first CI-safe RNG fixture, and SB-1-03's
local/manual `SPAU.PA` metadata output. The product is not complete. Phase 1
still needs a third reference output and the fixture contract before its exit
criteria can pass.

...
- [ ] Measured baselines on large maps with full simulation; optimizations hit
...
|---|---|---|---|---|
| SB-19-01 | Performance at scale | backlog | story-01-performance-at-scale.md | — |
...
Scaffolded; starts after Phase 18 closes.
